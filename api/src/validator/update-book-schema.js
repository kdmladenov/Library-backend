...
export default {
  title: (value) => typeof value === 'undefined' || (typeof value === 'string' && value.length >= book.MIN_TITLE_LENGTH && value.length <= book.MAX_TITLE_LENGTH),
  author: (value) => typeof value === 'undefined' || (typeof value === 'string' && value.length >= book.MIN_AUTHOR_LENGTH && value.length <= book.MAX_AUTHOR_LENGTH),
  ...
  isbn: (value) => typeof value === 'undefined' || (typeof value === 'string' && book.ISBN_REGEX.test(value)),
