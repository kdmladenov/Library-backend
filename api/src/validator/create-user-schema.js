...
export default {
  ...
  password: value => typeof value === 'string' && value.length > user.MIN_PASSWORD_LENGTH && value.length < user.MAX_PASSWORD_LENGTH && value.match(user.PASSWORD_REGEX),
  ...
  email: value => typeof value === 'string' && value.length > user.MIN_EMAIL_LENGTH && value.length < user.MAX_EMAIL_LENGTH && value.match(user.EMAIL_REGEX),
  phone: value => typeof value === 'undefined' || (typeof value === 'string' && value.match(user.PASSWORD_REGEX)),
};
