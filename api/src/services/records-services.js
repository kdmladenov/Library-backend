...
const getAllRecords = recordsData => async (search, searchBy, sort, order, pageSize, page, role) => {
  const result = await recordsData.getAllRecords(search, searchBy, sort, order, pageSize, page, role);
